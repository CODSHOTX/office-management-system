...
echo  '</a>';
  ...
  echo  '<li class="nav-item">';
  echo  '<a class="nav-link text-white active bg-gradient-primary" href="./tAllocation.php">';
      ...
      <div class="card my-4">
         <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
          <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
            <h6 class="text-white text-capitalize ps-3">Task Allocation</h6>
           </div>
        </div>
                ...
                <div class="card-body">
                  <div class="d-flex flex-row align-items-center">
                    <table class="table align-items-center mb-0">
                      ...
                      <input name="name" type="text" class="form-control border border-dark" id="exampleFormControlInput1"
                      placeholder="Employee Name"></div></td>
                      <td><div class="input-group input-group-outline mb-3 "><input name="eid" type="number" class="form-control border border-dark" id="exampleFormControlInput1"
                      placeholder="Employee Id"></div></td></tr>
                      <tr><td><div class="input-group input-group-outline mb-3 ">
...
$query="SELECT * FROM employees WHERE tName != '' ORDER BY priority";
        ...
        echo '<tr><th><h5 class="mb-0  fs-6">Done/Undone</h5></th><th><h5 class="mb-0  fs-6">Name</h5></th>
