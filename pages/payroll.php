...
echo  '</a>';
  ...
  echo  '<li class="nav-item">';
  echo   '<a class="nav-link text-white active bg-gradient-primary" href="payroll.php">';
...
<main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
 ...
 <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" data-scroll="true">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Payroll</li>
          </ol>
   ...
   echo          '<h6 class="text-white text-capitalize ps-3">Payroll</h6>';
   echo         '</div>';
   echo      '</div>';
...
if($result){
 ...
 <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Employee</th>';
      ...
      while($row=mysqli_fetch_array($result,MYSQLI_ASSOC))
        {
            echo '<tr>';
            echo '<td> <h6 class="mb-0 text-sm">'.$row['userName'].'</h6></td>';
            ...
            echo '<td>'.'</td>';
            echo "<td><a class='text-secondary font-weight-bold text-xs data-toggle=tooltip' data-original-title='Edit user' href=\"payrolEdit.php?udt=".$row['userId']."\"><i class='bi bi-pen'></i></a></td>";
                ...
                <div class="col-md-6 col-6">
                  <div class="card">
                    ...
                    <div class="card-body pt-0 p-3 text-center">
                      ...
                      <h5 class="mb-0">+<?php echo $_SESSION['salary'].".00";?> </h5>
                    </div>
                  </div>
                </div>
                <div class="col-md-6 col-6">
