...
//others
  ...
  echo  '</a>';
    ...
    echo  '<li class="nav-item">';
    echo  '<a class="nav-link text-white active bg-gradient-primary" href="portfolio.php">';
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Portfolio</li>
          </ol>
      ...
      <div class="card my-4">
         <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
          <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
            <h5 class="text-white text-capitalize ps-3">Recent Projects</h5>
           </div>
        </div>
         <div class="card-body px-0 pb-2">
            You currently have no project<br>
