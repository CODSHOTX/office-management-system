...
echo  '</a>';
  ...
  echo ' <li class="nav-item">';
  echo  '<a class="nav-link text-white active bg-gradient-primary" href="./employee.php">';
...
<main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
 ...
 <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" data-scroll="true">
   ...
   echo          '<h6 class="text-white text-capitalize ps-3">Employees list</h6>';
   echo         '</div>';
   echo      '</div>';
   echo       '<div class="card-body px-0 pb-2">';
      ...
      echo  ' <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Employee</th>';
      
      echo   '<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Department</th>';
      echo  ' <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Email</th>';
      echo  '<th class=" text-uppercase text-secondary text-xxs font-weight-bolder opacity-7"> Salary</th>';
      
      echo  '<th colspan = "2" class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7"> </th>';
      echo '</tr>';
      echo '</thead>';
      echo '<tbody>';
      while($row=mysqli_fetch_array($result,MYSQLI_ASSOC))
{
    ...
    echo '<td> <h6 class="mb-0 text-sm">'.$row['userName'].'</h6>
    <p class="text-xs text-secondary mb-0">'.$row['userId'].'</p></td>';
    echo '<td> <p class="text-xs font-weight-bold mb-0">'.$row['deptName'].'</p></td>';
    echo '<td> <p class="text-xs font-weight-bold mb-0">'.$row['email'].'</p></td>';
    
    
 
    echo '<td><span class="text-secondary text-xs font-weight-bold">'.number_format($row['empSal']).'</span></td>';
    
    echo '<td>'.'</td>';
    echo "<td><a class='text-secondary font-weight-bold text-xs data-toggle=tooltip' data-original-title='Edit user' href=\"../update.php?udt=".$row['userId']."\"><i class='bi bi-pen'></i></a></td>";
    echo "<td><a class='text-secondary font-weight-bold text-xs data-toggle=tooltip' data-original-title='Edit user' href=\"../del.php?udt=".$row['userId']."\"><i class='bi bi-trash2'></i></a></td>";
    echo '</tr>';
...
echo'</div>';
        ...
        <div class="col-12">
          <div class="card my-4">
            ...
            <div class="card-body px-0 pb-2">
              ...
              <div class="input-group input-group-outline mb-3 col-xs-3">
  ...
  <label class="input-group-text" for="did"></label>
  <select name="did" class="form-select  w-50" id="did">
    ...
    <option value="OTHERS">Others</option>
                    ...
                    <div class="text-center">
                      <button name="submit" type="button" class="btn btn-lg bg-gradient-primary btn-lg w-50 mt-4 mb-0">Register</button>
                    </div>
                    </div>
              </div>
            </div>
