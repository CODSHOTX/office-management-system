...
require_once '../inc/conn.php';
    ...
    if(count($_POST)>0) {
        ...
        header("location: payroll.php?rowUpdated");
        }
...
<main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
 ...
 <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" data-scroll="true">
    ...
    <div class="row">
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Edit Payroll Table</h6>
              </div>
            </div>
        ...
        <input type="text" name="userName" class="form-control-lg w-50 border border-dark"  required value="<?php echo $row['userName']; ?>">
</div>
       <br>
<h5>Employee Salary in Dollars</h5>
        <div class="input-group input-group-outline mb-3 col-xs-3">
        <input type="number" name="empSal" class="form-control-lg w-50 border border-dark"  required value="<?php echo $row['empSal']; ?>">
</div><br>
<h5>Employee Email:</h5>
        <div class="input-group input-group-outline mb-3 col-xs-3">
              
        <input type="text" name="email" class="form-control-lg w-50 border border-dark"  required value="<?php echo $row['email']; ?>">
</div>
<div>
