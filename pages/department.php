...
echo  '</a>';
  ...
  echo  '<li class="nav-item">';
  echo   '<a class="nav-link text-white active bg-gradient-primary " href="./department.php">';
  ...
  echo  '<li class="nav-item">';
  echo  '<a class="nav-link text-white " href="./sign-in.html">';
...
<main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
 ...
 <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" data-scroll="true">
   ...
   echo          '<h6 class="text-white text-capitalize ps-3">Department list</h6>';
   echo         '</div>';
   echo      '</div>';
   echo       '<div class="card-body px-0 pb-2">';
        ...
        echo  ' <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Department Id</th>';
        
        echo   '<th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Department Name</th>';
        while($row=mysqli_fetch_array($result))
{
    echo '<tr>';
    echo '<td> <h6 class="mb-0 text-sm">'.$row['deptId'].'</td>';
    echo '<td> <p class="text-xs font-weight-bold mb-0">'.$row['deptName'].'</td>';
    echo '<td>'.'</td>';
    echo "<td><a class='text-secondary font-weight-bold text-xs data-toggle=tooltip' data-original-title='Edit user' href=\"../update.php?udt=".$row['deptId']."\"><i class='bi bi-pen'></i></a></td>";
    echo "<td><a class='text-secondary font-weight-bold text-xs data-toggle=tooltip' data-original-title='Edit user' href=\"../del.php?udt=".$row['deptId']."\"><i class='bi bi-trash2'></i></a></td>";
...
mysqli_close($cnn);
echo'</div>';
echo'<form action="../inc/create-inc.php" method="post">';
echo '<h1>Create Department</h5><br>';
echo'<input type="text"  class="form-control form-control-lg w-50 border border-dark" name="dname" placeholder="Name..."><br>';
