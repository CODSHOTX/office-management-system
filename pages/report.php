...
//others
  ...
  echo  '</a>';
    ...
    echo  '<li class="nav-item">';
    echo  '<a class="nav-link text-white active bg-gradient-primary" href="report.php">';
       ...
       <div class="card my-4">
          <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
           <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
             <h6 class="text-white text-capitalize ps-3">Write Report</h6>
            </div>
         </div>
          <div class="card-body px-0 pb-2">
            <form method="post" action="logic.php">
              ...
              <div class="input-group input-group-outline mb-3 w-50 ">
                    <input name="title" type="text" class="form-control border border-dark fw-bold fs-4 " id="exampleFormControlInput1"
                      placeholder="Title"></div>
                      <div class="input-group input-group-outline mb-3 w-50  h-100">
 
  <textarea name="report" class="form-control border border-dark  h-800 fs-5" id="exampleFormControlTextarea1" rows="10" 
  placeholder="Content"></textarea>
</div>
<button name="post" type="submit" class="btn btn-primary">Send</button>
&nbsp; &nbsp; &nbsp;
          ...
          <div class="row align-items-center justify-content-lg-between">
            <div class="col-lg-6 mb-lg-0 mb-4">
              <div class="copyright text-center text-sm text-muted text-lg-start">
                ...
                <a href="https://www.creative-tim.com" class="font-weight-bold" target="_blank">MNK</a>
