   ...
   <div class="container mt-5">
        <?php foreach($query as $q){?>
            <div class="bg-dark p-5 rounded-lg text-white">
                <h1 class="text-light"><?php echo $q['title'];?></h1><hr class="border border-danger border-2 opacity-50">
                <p class="mt-5 border-left border-dark pl-3"><?php echo $q['report'];?><br><br>
                <div class="d-flex">
                    
                    <a href="editz.php?id=<?php echo $q['fId']?>" class="btn btn-light btn-sm mt-2" name="edit">Edit</a>
                    <form method="POST">
                        <input type="text" hidden value='<?php echo $q['fId']?>' name="id">
                        <button class="btn btn-primary btn-sm ml-2 mt-2" name="delete">Delete</button>
                    </form>
                </div>
